<?php 
/** Fenom template '/admin/users/index.php' compiled at 2016-10-25 21:20:56 */
...
<div class="col-xs-12">
	<div class="box">
		...
		<div class="box-body">
			...
			<tr>
				<td colspan="4"></td>
				<td class="text-right"><a title="Добавить пользователя" class="btn btn-success" href="<?php
/* /admin/users/index.php:61: {get_url('admin/users/add')} */
 echo get_url('admin/users/add'); ?>"><i class="fa fa-plus"></i></a></td>
			</tr>
			</tfoot>
		  </table>
		</div>
...
<script>
  $(function () {
	...
	'options' => 384,
	'provider' => false,
	'name' => '/admin/users/index.php',
	'base_name' => '/admin/users/index.php',
	'time' => 1477241070,
	'depends' => array (
  0 => 
  array (
    'admin/main.php' => 1477241037,
    '/admin/users/index.php' => 1477241070,
  ),
),
	'macros' => array(),
