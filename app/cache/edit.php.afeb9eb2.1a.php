...
/* /admin/groups/edit.php:6: {$action} */
 echo $var["action"]; ?>" method="POST">
			<div class="box-body">
				<div class="form-group">
					<label for="addGroup" class="col-sm-2 control-label">Название группы</label>
					<div class="col-sm-10">
						<input name="groupName" type="text" class="form-control" value="<?php
/* /admin/groups/edit.php:11: {$groupName} */
 echo $var["groupName"]; ?>"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input name="groupAlias" type="text" class="form-control" value="<?php
/* /admin/groups/edit.php:17: {$groupAlias} */
 echo $var["groupAlias"]; ?>" />
...
<script>
  $(function () {
	...
	'options' => 384,
	'provider' => false,
	'name' => '/admin/groups/edit.php',
	'base_name' => '/admin/groups/edit.php',
	'time' => 1477678045,
	'depends' => array (
  0 => 
  array (
    'admin/main.php' => 1477673515,
    '/admin/groups/edit.php' => 1477678045,
  ),
),
	'macros' => array(),
