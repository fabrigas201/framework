...
<link rel="stylesheet" type="text/css" href="{asset('web/assets/css/960.css')}" media="all" />
<link rel="stylesheet" type="text/css" href="{asset('web/assets/css/screen.css')}" media="screen" />
<link rel="stylesheet" type="text/css" href="{asset('web/assets/css/color.css')}" media="screen" />
<!--[if lt IE 9]>
<link rel="stylesheet" type="text/css" href="{asset('web/assets/css/ie.css')}" media="screen" />
<![endif]-->

<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js"></script>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.11/jquery-ui.min.js"></script>
<script type="text/javascript" src="{asset('web/assets/js/shoppica.js')}"></script>
